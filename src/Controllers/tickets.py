...
class TicketPanel(discord.ui.View):
    ...
    @discord.ui.button(label="Fechar Ticket", style=discord.ButtonStyle.red, emoji="❌", custom_id="persistent:close_ticket")
...
class TicketCreationView(discord.ui.View):
    ...
    @discord.ui.button(label="Abrir Ticket", style=discord.ButtonStyle.green, emoji="🎫", custom_id="persistent:open_ticket")
    async def button_open(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await ticket_channel.send(embed=view.embed, view=view)
...
def loadPersistence(bot: discord.Client):
    bot.add_view(TicketCreationView())
    bot.add_view(TicketPanel())
